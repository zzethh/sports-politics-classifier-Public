...
_(On the cluster, use `module load python/3.10`)_
...
_The script ends with an interactive mode where you can type sentences to test the classifier in real-time._
